                    ...
                    <div className="login-box col-md-9 p-0 d-flex">
                        ...
                        <div className="content-login-section">
                            <div className="otr-login">
                                ...
                                <span className="text-note-psw">
                                    Please note: If your email address is on file with FCA Tracker, then a password reset email will be sent to you
                                    momentarily.
                                    <br />
                                    <br />
                                    If your email is not on file with us, you will need to contact your administrator to get an account set up.{" "}
                                </span>
