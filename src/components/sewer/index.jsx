...
class index extends Component {
    state = {
        ...
        errorMessage: "",
        projectList: [],
        paginationParams: this.props.sewerReducer.entityParams.paginationParams,
        showViewModal: false,
        ...
        tableLoading: false,
        projectData: {},
        selectedRowId: this.props.sewerReducer.entityParams.selectedRowId,
        params: this.props.sewerReducer.entityParams.params,
        selectedBuilding: this.props.match.params.id || null,
        selectedMeterTemplate: this.props.match.params.id || this.props.sewerReducer.entityParams.selectedEntity,
        tableData: {
            keys: electricTableData.keys,
            config: this.props.sewerReducer.entityParams.tableConfig || electricTableData.config
        },
        infoTabsData: [],
        alertMessage: "",
        wildCardFilterParams: this.props.sewerReducer.entityParams.wildCardFilterParams,
        filterParams: this.props.sewerReducer.entityParams.filterParams,
        historyPaginationParams: this.props.sewerReducer.entityParams.historyPaginationParams,
        historyParams: this.props.sewerReducer.entityParams.historyParams,
        logData: {
            count: "",
            data: []
        },
    ...
    refreshMeterList = async () => {
        ...
        meterList = this.props.sewerReducer.getAllMeterReadingsResponse ? this.props.sewerReducer?.getAllMeterReadingsResponse?.readings : [];
        totalCount = this.props.sewerReducer.getAllMeterReadingsResponse ? this.props.sewerReducer.getAllMeterReadingsResponse?.count : 0;
        totals = this.props.sewerReducer.getAllMeterReadingsResponse ? this.props.sewerReducer.getAllMeterReadingsResponse?.totals : {};
        ...
        if (meterList && !meterList.length && paginationParams.currentPage) {
            ...
            await this.props.getAllReadings({ ...params, ...subParams, meter_type: tab });
            meterList = this.props.sewerReducer.getAllMeterReadingsResponse ? this.props.sewerReducer?.getAllMeterReadingsResponse : [];
            totalCount = this.props.sewerReducer.getAllMeterReadingsResponse ? this.props.sewerReducer.getAllMeterReadingsResponse?.count : 0;
        }
        ...
        if (
            meterList &&
            !meterList.length &&
            this.props.sewerReducer.getAllMeterReadingsResponse &&
            this.props.sewerReducer.getAllMeterReadingsResponse.error
        ) {
            await this.setState({ alertMessage: this.props.sewerReducer.getAllMeterReadingsResponse.error });
            this.showAlert();
        }
        ...
        this.setState({
            tableData: {
                ...tableData,
                data: meterList,
                config: this.props.sewerReducer.entityParams.tableConfig || tableData.config
            },
            meterList,
            ...
            summaryRowData: {
                ccf_usage: totals?.ccf_usage || 0,
                ccf_cost: totals?.ccf_cost || 0
            },
    ...
    getListForCommonFilter = async params => {
        ...
        await this.props.getListForCommonFilter({ ...params, ...subParams, search, list, filters, meter_type: tab });
        return (this.props.sewerReducer.getListForCommonFilterResponse && this.props.sewerReducer.getListForCommonFilterResponse.list) || [];
    };
    ...
    handleAddMeterTemplate = async narrativeTemplate => {
        ...
        if (this.props.sewerReducer.addMeterTemplateResponse && this.props.sewerReducer.addMeterTemplateResponse.error) {
            await this.setState({
                alertMessage: this.props.sewerReducer.addMeterTemplateResponse.error
            });
            this.showAlert();
        } else {
            await this.setState({
                alertMessage: this.props.sewerReducer.addMeterTemplateResponse && this.props.sewerReducer.addMeterTemplateResponse.message
            });
            this.showAlert();
            await this.refreshMeterList();
            history.push(path);
    ...
    handleUpdateMeterTemplate = async (meterTemplate_id, meterTemplate) => {
        ...
        if (this.props.sewerReducer.updateMeterTemplateResponse && this.props.sewerReducer.updateMeterTemplateResponse.error) {
            await this.setState({ alertMessage: this.props.sewerReducer.updateMeterTemplateResponse.error });
            this.showAlert();
        } else {
            this.setState({
                alertMessage:
                    (this.props.sewerReducer.updateMeterTemplateResponse && this.props.sewerReducer.updateMeterTemplateResponse.message) ||
    ...
    deleteMeterTemplateOnConfirm = async () => {
        ...
        if (this.props.sewerReducer.deleteMeterTemplateResponse && this.props.sewerReducer.deleteMeterTemplateResponse.error) {
            await this.setState({ alertMessage: this.props.sewerReducer.deleteMeterTemplateResponse.error });
            this.setState({
            ...
            await this.setState({ alertMessage: this.props.sewerReducer.deleteMeterTemplateResponse.message || "Deleted successfully" });
            await this.refreshMeterList();
            this.setState({
                showConfirmModal: false,
                selectedBuilding: null
    ...
    getDataById = async meterTemplateId => {
        ...
        return this.props.sewerReducer.getMeterTemplateByIdResponse;
    };
    ...
    exportTableXl = async () => {
        ...
        if (this.props.sewerReducer.narrativeTemplateExportResponse && this.props.sewerReducer.narrativeTemplateExportResponse.error) {
            await this.setState({ alertMessage: this.props.sewerReducer.narrativeTemplateExportResponse.error });
            this.showAlert();
        }
    };
    ...
    getLogData = async () => {
        ...
        if (this.props.sewerReducer.getAllNarrativeTemplateLogsResponse && this.props.sewerReducer.getAllNarrativeTemplateLogsResponse.error) {
            await this.setState({ alertMessage: this.props.sewerReducer.getAllNarrativeTemplateLogsResponse.error });
            this.showAlert();
        } else {
            await this.setState({
                logData: {
    ...
    deleteLogOnConfirm = async () => {
        ...
        if (this.props.sewerReducer.deleteNarrativeTemplateLogResponse && this.props.sewerReducer.deleteNarrativeTemplateLogResponse.error) {
            await this.setState({ alertMessage: this.props.sewerReducer.deleteNarrativeTemplateLogResponse.error });
            this.showAlert();
        }
        await this.getLogData(this.props.match.params.id);
        this.setState({
    ...
    HandleRestoreRegionLog = async id => {
        ...
        if (this.props.sewerReducer.restoreNarrativeTemplateLogResponse && this.props.sewerReducer.restoreNarrativeTemplateLogResponse.error) {
            await this.setState({ alertMessage: this.props.sewerReducer.restoreNarrativeTemplateLogResponse.error });
            this.showAlert();
        }
    };
            ...
            <LoadingOverlay active={isLoading} spinner={<Loader />} fadeSpeed={10}>
                {settingType === "add" || settingType === "edit" ? (
                    ...
                    <MeterTemplateInfo
                        ...
                        hasEdit={hasEdit && checkPermission("forms", "meter_readings", "edit")}
...
const mapStateToProps = state => {
    const { projectReducer, commonReducer, sewerReducer } = state;
    return { projectReducer, commonReducer, sewerReducer };
};
