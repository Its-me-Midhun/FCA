...
class RecommendationTemplate extends Component {
    render() {
        const {
            ...
            handleDeleteRecommendationTemplate,
            showEditPage,
            handlePerPageChange,
            handlePageClick,
            showAddForm,
            ...
            wildCardFilter,
            handleHideColumn,
            getListForCommonFilterReportNoteTemplate,
            updateCommonFilter,
            commonFilter,
            resetAllFilters,
            ...
            <React.Fragment>
                <div className={`${section !== "regioninfo" ? "dtl-sec" : ""} col-md-12 floor-detail master-templates`}>
                        ...
                        <div className="rgt">
                            ...
                            {showAddButton && (
                                <button className="add-btn" onClick={() => showAddForm()}>
                                    <i className="fas fa-plus" /> Add New Recommendation Template
                                </button>
                            )}
                        </div>
                    </div>
                    <Table
                        ...
                        handleDeleteItem={handleDeleteRecommendationTemplate}
                        showWildCardFilter={showWildCardFilter}
                        ...
                        getListForCommonFilter={getListForCommonFilterReportNoteTemplate}
...
export default withRouter(connect(mapStateToProps, { ...projectActions })(RecommendationTemplate));
