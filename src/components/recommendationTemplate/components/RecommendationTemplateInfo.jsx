...
class RecommendationTemplate extends Component {
    state = {
        isloading: true,
        basicDetails: {
            name: "",
    ...
    refreshinfoDetails = async () => {
        let reportNoteTemplateData = await this.props.getDataById(this.props.match.params.id);
        if (reportNoteTemplateData && reportNoteTemplateData.success) {
            this.setState({
                basicDetails: {
                    name: reportNoteTemplateData.name,
                    text_format: reportNoteTemplateData.text_format,
                    description: reportNoteTemplateData.description,
                    unit: reportNoteTemplateData.unit,
                    cost_per_unit: reportNoteTemplateData.cost_per_unit,
                    created_at: reportNoteTemplateData.created_at,
                    updated_at: reportNoteTemplateData.updated_at
                },
                isloading: false,
                isHistory: false
            });
    ...
    restoreLogOnConfirm = async () => {
        ...
        await this.props.HandleRestoreReportNoteTemplateLog(selectedLog);
        this.setState({
            showConfirmModalLog: false,
            selectedLog: null,
            isHistory: false
...
export default withRouter(RecommendationTemplate);
