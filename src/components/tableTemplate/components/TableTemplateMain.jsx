...
class SiteMain extends Component {
    render() {
        const {
            ...
            wildCardFilter,
            handleHideColumn,
            getListForCommonFilterTableTemplate,
            updateCommonFilter,
            commonFilter,
            resetAllFilters,
            resetAll,
            ...
            <React.Fragment>
                <div className={`${section !== "regioninfo" ? "dtl-sec" : ""} col-md-12 floor-detail master-templates`}>
                        ...
                        <div className="rgt">
                            ...
                            {showAddButton && (
                                <button className="add-btn" onClick={() => showAddForm()}>
                                    <i className="fas fa-plus" /> Add New Table Template
                                </button>
                            )}
                        </div>
                    </div>
                    <Table
                        ...
                        handleDeleteItem={handleDeleteTableTemplate}
                        showWildCardFilter={showWildCardFilter}
                        ...
                        getListForCommonFilter={getListForCommonFilterTableTemplate}
