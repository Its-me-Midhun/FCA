...
class SiteMain extends Component {
    render() {
        const {
            ...
            wildCardFilter,
            handleHideColumn,
            getListForCommonFilterReportParagraph,
            updateCommonFilter,
            commonFilter,
            resetAllFilters,
            resetAll,
            ...
            <React.Fragment>
                <div className={`${section !== "regioninfo" ? "dtl-sec" : ""} col-md-12 floor-detail master-templates`}>
                        ...
                        <div className="rgt">
                            ...
                            {showAddButton && (
                                <button className="add-btn" onClick={() => showAddForm()}>
                                    <i className="fas fa-plus" /> Add Report Paragraph
                                </button>
                            )}
                        </div>
                    </div>
                    <Table
                        ...
                        handleDeleteItem={handleDeleteReportParagraph}
                        showWildCardFilter={showWildCardFilter}
                        ...
                        getListForCommonFilter={getListForCommonFilterReportParagraph}
