...
class ClientMain extends Component {
    render() {
        const {
            ...
            wildCardFilter,
            handleHideColumn,
            getListForCommonFilterBuildingType,
            updateCommonFilter,
            commonFilter,
            resetAllFilters,
            resetAll,
                ...
                <div className={`${section !== "regioninfo" ? "dtl-sec" : ""} col-md-12`}>
                    ...
                    <div className="building-type-table">
                        <Table
                            ...
                            handleDeleteItem={handleDeleteBuildingType}
                            showWildCardFilter={showWildCardFilter}
...
export default withRouter(connect(mapStateToProps, { ...clientActions })(ClientMain));
