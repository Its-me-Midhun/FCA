...
class FormData extends Component {
    ...
    renderData = () => {
        const { logArray, graphArray, efciArray,
            formArray, menuArray } = this.props
        switch (this.props.tabData) {
            case 'form': return formArray;
            case 'efci': return efciArray;
            case 'menu': return menuArray;
            case 'charts_graphs': return graphArray;
            case 'log': return logArray;
        }
    }
        ...
        return (
            <div className="table-section table-scroll">
                ...
                <table className="table table-common table-min-height mt-0 tbl-area">
                    <thead>
                        <tr>
                            ...
                            <th className="reg-name cursor-pointer">
                                <label className="container-check">View
                                  <input type="checkbox"
                            ...
                            {this.props.tabData == "form" ? <th className="client-wid cursor-pointer">
                                <label className="container-check">Create
                                  <input type="checkbox"
                            ...
                            {this.props.tabData == "efci" ? <th className=" cursor-pointer">
                                <label className="container-check">Sandbox
                                  <input type="checkbox"
                            ...
                            {((this.props.tabData == "form" || this.props.tabData == "efci")) ? <th className=" cursor-pointer">
                                <label className="container-check">Edit
                                  <input type="checkbox"
                            ...
                            {this.props.tabData == "log" ? <th className=" cursor-pointer">
                                <label className="container-check">Restore
                                  <input type="checkbox"
                            ...
                            {((this.props.tabData == "form" || this.props.tabData == "log")) ? <th className=" cursor-pointer">
                                <label className="container-check">Delete
                                  <input type="checkbox"
                            ...
                            {((this.props.tabData == "form") || (this.props.tabData == "charts_graphs")) ? <th className=" cursor-pointer">
                                <label className="container-check">Export
                                  <input type="checkbox"
                    ...
                    <tbody>
                        {currentContent ? Object.keys(currentContent).map((fc, i) => {
                            return <tr key={i}>
                                <td>{fc}</td>
                                <td><label className={currentContent[fc] && currentContent[fc].hasOwnProperty('view') ? "container-check" : "container-check disabled"}><input type="checkbox"
                                ...
                                {this.props.tabData == "form" ? <td><label className={currentContent[fc] && currentContent[fc].hasOwnProperty('create') ? "container-check" : "container-check disabled"}><input
                                    type="checkbox"
                                ...
                                /><span className="checkmark"></span></label></td>
                                    : null}
                                {this.props.tabData == "efci" ? <td><label className={currentContent[fc] && currentContent[fc].hasOwnProperty('sandbox') ? "container-check" : "container-check disabled"}><input
                                    type="checkbox"
                                ...
                                /><span className="checkmark"></span></label></td>
                                    : null}
                                {((this.props.tabData == "form" || this.props.tabData == "efci")) ? <td><label
                                    className={currentContent[fc] && currentContent[fc].hasOwnProperty('edit') ? "container-check" : "container-check disabled"}>
                                    <input type="checkbox"
                                    ...
                                    /><span className="checkmark"></span></label></td> : null}
                                {this.props.tabData == "log" ? <td><label
                                    className={currentContent[fc] && currentContent[fc].hasOwnProperty('restore') ? "container-check" : "container-check disabled"}>
                                    <input type="checkbox"
                                    ...
                                    /><span className="checkmark"></span></label></td> : null}
                                {((this.props.tabData == "form" || this.props.tabData == "log")) ? <td><label className={currentContent[fc] && currentContent[fc].hasOwnProperty('delete') ? "container-check" : "container-check disabled"}>
                                    <input type="checkbox"
                                    ...
                                    /><span className="checkmark"></span></label></td> : null}
                                {((this.props.tabData == "form") || (this.props.tabData == "charts_graphs")) ? <td>
                                    <label className={currentContent[fc] && currentContent[fc].hasOwnProperty('export') ? "container-check" : "container-check disabled"}>
                                        <input type="checkbox"
