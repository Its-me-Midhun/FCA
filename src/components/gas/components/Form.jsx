...
class Form extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            subTemplates: [
                ...
                { key: "kw_usage", type: "numberclick", label: "kWh usage *" },
                ...
                { key: "mmbtu_transport_cost", type: "number", label: "MMBTU Transport Cost ($) *", prefix: true },
                { key: "mmbtu_well_head_cost", type: "number", label: "MMBTU Well Head Cost ($) *", prefix: true }
            ...
            initialClientUsers: [],
            alertMessage: "Please enter MMBTU usage to calculate"
        };
    }
    ...
    paramFetcher = async () => {
        ...
        if (sect === "buildinginfo") {
            let {
                gasReducer: { getBuildingByIdResponse }
            } = this.props;
        ...
        if (sect === "siteinfo") {
            ...
            let {
                gasReducer: { getSiteByIdResponse }
            } = this.props;
    ...
    componentDidUpdate = (prevProps, prevState) => {
        ...
        if (currVal?.building_id !== prevState?.values?.building_id) {
            currVal?.building_id && this.handleAccountDetails({ building_id: currVal?.building_id, account_type: "Gas" });
        }
        if (currVal?.account_id !== prevState?.values?.account_id) {
            currVal?.account_id && this.handleMeterDetails({ account_id: currVal?.account_id, account_type: "Gas" });
        }
    };
    ...
    handleAccountDetails = async params => {
        ...
        let { accounts } = this.props.gasReducer?.getAccountsListResponse;
        this.setState({
            accounts
        });
    };
    ...
    handleRegionDetails = async id => {
        ...
        let { regions } = this.props.gasReducer?.getRegionListResponse;
        this.setState({
            regions
        });
    };
    ...
    handleSiteDetails = async (id, params) => {
        ...
        let { sites } = this.props.gasReducer?.getSiteListResponse;
        this.setState({
            sites
        });
    };
    ...
    handleBuildingDetails = async (id, params) => {
        ...
        let { buildings } = this.props.gasReducer?.getBuildingListResponse;
        this.setState({
            buildings
        });
    };
    handleMeterDetails = async params => {
        ...
        let { meters } = this.props.gasReducer?.getMeterListResponse;
        this.setState({
            meters
        });
    };
    ...
    addTemplate = async () => {
        ...
        if (this.validate()) {
            ...
            await handleAddMeterTemplate({
                ...
                ccf_cost: null,
                mmbtu_total_gas_cost: parseFloat(values?.mmbtu_transport_cost) + parseFloat(values?.mmbtu_well_head_cost)
            });
            this.setState({
                isUploading: false
            });
    ...
    calculateMmbtu = () => {
        ...
        this.setState({
            values: {
                ...values,
                kw_usage: values?.mmbtu_usage * 293.07
            }
        });
    };
