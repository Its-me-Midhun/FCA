...
class index extends Component {
    state = {
        ...
        errorMessage: "",
        projectList: [],
        paginationParams: this.props.gasReducer.entityParams.paginationParams,
        showViewModal: false,
        ...
        tableLoading: false,
        projectData: {},
        selectedRowId: this.props.gasReducer.entityParams.selectedRowId,
        params: this.props.gasReducer.entityParams.params,
        selectedBuilding: this.props.match.params.id || null,
        selectedMeterTemplate: this.props.match.params.id || this.props.gasReducer.entityParams.selectedEntity,
        tableData: {
            keys: electricTableData.keys,
            config: this.props.gasReducer.entityParams.tableConfig || electricTableData.config
        },
        infoTabsData: [],
        alertMessage: "",
        wildCardFilterParams: this.props.gasReducer.entityParams.wildCardFilterParams,
        filterParams: this.props.gasReducer.entityParams.filterParams,
        historyPaginationParams: this.props.gasReducer.entityParams.historyPaginationParams,
        historyParams: this.props.gasReducer.entityParams.historyParams,
        logData: {
            count: "",
            data: []
        },
    ...
    refreshMeterList = async () => {
        ...
        meterList = this.props.gasReducer.getAllMeterReadingsResponse ? this.props.gasReducer?.getAllMeterReadingsResponse?.readings : [];
        totalCount = this.props.gasReducer.getAllMeterReadingsResponse ? this.props.gasReducer.getAllMeterReadingsResponse?.count : 0;
        totals = this.props.gasReducer.getAllMeterReadingsResponse ? this.props.gasReducer.getAllMeterReadingsResponse?.totals : {};
        ...
        if (meterList && !meterList.length && paginationParams.currentPage) {
            ...
            await this.props.getAllReadings({ ...params, ...subParams, meter_type: tab });
            meterList = this.props.gasReducer.getAllMeterReadingsResponse ? this.props.gasReducer?.getAllMeterReadingsResponse : [];
            totalCount = this.props.gasReducer.getAllMeterReadingsResponse ? this.props.gasReducer.getAllMeterReadingsResponse?.count : 0;
        }
        ...
        if (
            meterList &&
            !meterList.length &&
            this.props.gasReducer.getAllMeterReadingsResponse &&
            this.props.gasReducer.getAllMeterReadingsResponse.error
        ) {
            await this.setState({ alertMessage: this.props.gasReducer.getAllMeterReadingsResponse.error });
            this.showAlert();
        }
        ...
        this.setState({
            tableData: {
                ...tableData,
                data: meterList,
                config: this.props.gasReducer.entityParams.tableConfig || tableData.config
            },
            meterList,
            ...
            summaryRowData: {
                ...
                mmbtu_total_gas_cost: totals?.mmbtu_total_gas_cost || 0,
                mmbtu_transport_cost: totals?.mmbtu_transport_cost || 0,
                mmbtu_usage: totals?.mmbtu_usage || 0,
                mmbtu_well_head_cost: totals?.mmbtu_well_head_cost || 0
            },
    ...
    getListForCommonFilter = async params => {
        ...
        return (this.props.gasReducer.getListForCommonFilterResponse && this.props.gasReducer.getListForCommonFilterResponse.list) || [];
    };
    ...
    handleAddMeterTemplate = async narrativeTemplate => {
        ...
        if (this.props.gasReducer.addMeterTemplateResponse && this.props.gasReducer.addMeterTemplateResponse.error) {
            await this.setState({
                alertMessage: this.props.gasReducer.addMeterTemplateResponse.error
            });
            this.showAlert();
        } else {
            await this.setState({
                alertMessage: this.props.gasReducer.addMeterTemplateResponse && this.props.gasReducer.addMeterTemplateResponse.message
            });
            this.showAlert();
            await this.refreshMeterList();
            history.push(path);
    ...
    handleUpdateMeterTemplate = async (meterTemplate_id, meterTemplate) => {
        ...
        if (this.props.gasReducer.updateMeterTemplateResponse && this.props.gasReducer.updateMeterTemplateResponse.error) {
            await this.setState({ alertMessage: this.props.gasReducer.updateMeterTemplateResponse.error });
            this.showAlert();
        } else {
            this.setState({
                alertMessage:
                    (this.props.gasReducer.updateMeterTemplateResponse && this.props.gasReducer.updateMeterTemplateResponse.message) ||
    ...
    deleteMeterTemplateOnConfirm = async () => {
        ...
        if (this.props.gasReducer.deleteMeterTemplateResponse && this.props.gasReducer.deleteMeterTemplateResponse.error) {
            await this.setState({ alertMessage: this.props.gasReducer.deleteMeterTemplateResponse.error });
            this.setState({
            ...
            await this.setState({ alertMessage: this.props.gasReducer.deleteMeterTemplateResponse.message || "Deleted successfully" });
            await this.refreshMeterList();
            this.setState({
                showConfirmModal: false,
                selectedBuilding: null
    ...
    getDataById = async meterTemplateId => {
        ...
        return this.props.gasReducer.getMeterTemplateByIdResponse;
    };
    ...
    exportTableXl = async () => {
        ...
        if (this.props.gasReducer.narrativeTemplateExportResponse && this.props.gasReducer.narrativeTemplateExportResponse.error) {
            await this.setState({ alertMessage: this.props.gasReducer.narrativeTemplateExportResponse.error });
            this.showAlert();
        }
    };
    ...
    getLogData = async () => {
        ...
        if (this.props.gasReducer.getAllNarrativeTemplateLogsResponse && this.props.gasReducer.getAllNarrativeTemplateLogsResponse.error) {
            await this.setState({ alertMessage: this.props.gasReducer.getAllNarrativeTemplateLogsResponse.error });
            this.showAlert();
        } else {
            await this.setState({
                logData: {
    ...
    deleteLogOnConfirm = async () => {
        ...
        if (this.props.gasReducer.deleteNarrativeTemplateLogResponse && this.props.gasReducer.deleteNarrativeTemplateLogResponse.error) {
            await this.setState({ alertMessage: this.props.gasReducer.deleteNarrativeTemplateLogResponse.error });
            this.showAlert();
        }
        await this.getLogData(this.props.match.params.id);
        this.setState({
    ...
    HandleRestoreRegionLog = async id => {
        ...
        if (this.props.gasReducer.restoreNarrativeTemplateLogResponse && this.props.gasReducer.restoreNarrativeTemplateLogResponse.error) {
            await this.setState({ alertMessage: this.props.gasReducer.restoreNarrativeTemplateLogResponse.error });
            this.showAlert();
        }
    };
...
const mapStateToProps = state => {
    const { projectReducer, commonReducer, gasReducer } = state;
    return { projectReducer, commonReducer, gasReducer };
};
