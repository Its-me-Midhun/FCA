...
class BasicDetails extends Component {
    ...
    setToolTip(basicDetails, name) {
        return basicDetails && basicDetails.length > 25 ? (
            <Tooltip
                placement="left"
                overlay={basicDetails && basicDetails.length > 25 ? basicDetails || "" : ""}
                animation="zoom"
            ...
            >
                <div
                    ...
                    data-tip={basicDetails && basicDetails.length > 25 ? basicDetails || "" : ""}
                    data-multiline={true}
                    data-place="left"
                    data-effect="solid"
                ...
                >
                    ...
                    <p className="m-details">
                        {basicDetails && basicDetails.length > 25 ? basicDetails.substring(0, 25) + "..." : basicDetails || "-"}
                    </p>
                </div>
            </Tooltip>
        ) : (
            ...
            >
                <p className="m-label">{name}</p>
                <p className="m-details">{basicDetails && basicDetails.length > 25 ? basicDetails.substring(0, 25) + "..." : basicDetails || "-"}</p>
            </div>
        );
    }

    setToolTipRecommentation(basicDetails, name) {
        return basicDetails && basicDetails.length > 30 ? (
            <Tooltip
                placement="left"
                overlay={basicDetails && basicDetails.length > 30 ? basicDetails || "" : ""}
                animation="zoom"
                defaultVisible={false}
                trigger={["hover"]}
                overlayInnerStyle={{
            ...
            >
                <div
                    className="content-block-card"
                    data-tip={basicDetails && basicDetails.length > 30 ? basicDetails || "" : ""}
                    data-multiline={true}
                    data-place="left"
                    data-effect="solid"
                    data-background-color="#4991ff"
                >
                    <p className="m-label">{name}</p>
                    <p className="m-details">
                        {basicDetails && basicDetails.length > 30 ? basicDetails.substring(0, 30) + "..." : basicDetails || "-"}
                    </p>
                </div>
            </Tooltip>
        ) : (
            ...
            >
                <p className="m-label">{name}</p>
                <p className="m-details">{basicDetails && basicDetails.length > 30 ? basicDetails.substring(0, 30) + "..." : basicDetails || "-"}</p>
            </div>
        );
    }
                    ...
                    {isHistoryView ? (
                        ...
                        <div className="col-md-12 detail-recom">
                                ...
                                <div className="row align-items-stretch">
                                    <div className="col-md-8 p-0 m-details-content-outer">
                                        <div className="m-details-content-block">
                                            <div className="d-flex content-block-2 mt-1">
                                                ...
                                                <div className="content-block-outer br-left br-btm ">
                                                    {this.setToolTip(basicDetails && basicDetails.identifier, "Identifier")}
                                                </div>
                                                <div className="content-block-outer br-left br-btm ">
                                            ...
                                            <div className="d-flex content-block-2 mt-1">
                                                ...
                                                <div className="content-block-outer br-left br-btm">
                                                    {this.setToolTip(basicDetails && basicDetails.document_type?.name, "Document Type")}
                                                </div>
                                                <div className="content-block-outer br-left br-btm">
                                                    {this.setToolTip(
                                            ...
                                            <div className="d-flex content-block-2 mt-1">
                                                ...
                                                <div className="content-block-outer br-left br-btm">
                                                    {/* {this.setToolTipBuilding(basicDetails, "Building")} */}
                                                    {basicDetails &&
                                                    basicDetails.building &&
                                                    basicDetails.building.description &&
                                                    basicDetails.building.description.length > 20 ? (
                                                        <Tooltip
                                                            placement="left"
                                                        ...
                                                        >
                                                            <div
                                                                ...
                                                                data-background-color="#4991ff"
                                                            >
                                                                <p className="m-label">Building</p>
                                                                <p className="m-details">
                                        ...
                                        <div className="d-flex content-block-2 mt-1">
                                            ...
                                            <div className="content-block-outer br-left br-btm ">
                                                {this.setToolTip(basicDetails && basicDetails.description && basicDetails.description, "Description")}
                                            </div>
                                        </div>
                                        {/* <div className="content-block-outer mt-1">
                                    <div className="content-block-outer ">
                                       <p className="m-label">Initiative</p>
                                       <p className="m-details">
                                          {basicDetails && basicDetails.initiative &&
                                             basicDetails.initiative.name}
                                       </p>
                                    </div>
                                    <div className="content-block-card">
                                       <p className="m-label">Recommendation</p>
                                       <p className="m-details">
                                          {basicDetails && basicDetails.recommendation && basicDetails.recommendation.name || "-"}
                                       </p>
                                    </div>
                                 </div> */}
                                    </div>
                            ...
                            <div className="outer-rcm mt-1">
                                ...
                                {this.setToolTipDescription(basicDetails && basicDetails.status && basicDetails.status, "Status")}
