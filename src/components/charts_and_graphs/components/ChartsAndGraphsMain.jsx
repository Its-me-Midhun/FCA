...
class ChartsAndGraphsMain extends Component {
    render() {
        const {
            showWildCardFilter,
            paginationParams,
            ...
            wildCardFilter,
            handleHideColumn,
            getListForCommonFilterChartsAndGraphs,
            updateCommonFilter,
            commonFilter,
            resetAllFilters,
            resetAll,
            ...
            <React.Fragment>
                <div className={`${section !== "regioninfo" ? "dtl-sec" : ""} col-md-12 floor-detail master-templates`}>
                        ...
                        <div className="rgt">
                            ...
                            {showAddButton && (
                                <button className="add-btn" onClick={() => showAddForm()}>
                                    <i className="fas fa-plus" /> Add Special Reports
                                </button>
                            )}
                        </div>
                    </div>
                    <Table
                        ...
                        handleDeleteItem={handleDeleteChartsAndGraphs}
                        showWildCardFilter={showWildCardFilter}
                        ...
                        getListForCommonFilter={getListForCommonFilterChartsAndGraphs}
                        ...
                        handleChartsAndGraphsActions={handleChartsAndGraphsActions}
                    />
...
export default withRouter(connect(mapStateToProps, { ...projectActions })(ChartsAndGraphsMain));
