            ...
            <React.Fragment>
                <div className={`${section !== "regioninfo" ? "dtl-sec" : ""} col-md-12 floor-detail master-templates`}>
                    ...
                    <Table
                        ...
                        getListForCommonFilter={getListForCommonFilterAccount}
...
export default withRouter(connect(mapStateToProps, { ...projectActions })(AccountsMain));
