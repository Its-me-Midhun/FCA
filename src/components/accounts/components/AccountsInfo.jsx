...
class AccountsInfo extends Component {
    ...
    refreshinfoDetails = async () => {
        let accountData = await this.props.getDataById(this.props.match.params.id);
        if (accountData && accountData.success) {
            this.setState({
                basicDetails: {
                    client: accountData.client?.name,
                    code: accountData?.code,
                    region: accountData.region?.name,
                    site: accountData.site?.name,
                    building: accountData.building?.name,
                    building_sf: "",
    ...
    restoreLogOnConfirm = async () => {
        ...
        await this.props.HandleRestoreAccountLog(selectedLog);
        this.setState({
            showConfirmModalLog: false,
            selectedLog: null,
            isHistory: false
