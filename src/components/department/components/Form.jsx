...
class From extends Component {
    ...
    componentDidMount = async () => {
        ...
        if (selectedTrade) {
            await this.props.getCategoryByOne(selectedTrade);
            const {
                departmentReducer: {
                        ...
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title" id="exampleModalLabel">
                                    {selectedProject ? "Edit Department" : "Add New Department"}
                                </h5>
...
const mapStateToProps = state => {
    const { buildingTypeReducer, buildingReducer, departmentReducer } = state;
    return { buildingTypeReducer, buildingReducer, departmentReducer };
};
