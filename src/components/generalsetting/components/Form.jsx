...
class From extends Component {
    ...
    componentDidMount = async () => {
        ...
        if (selectedTrade) {
            await this.props.getGeneralByOne(selectedTrade);
            const {
...
const mapStateToProps = state => {
    const { buildingTypeReducer, buildingReducer, projectReducer, generalsettingReducer } = state;
    return { buildingTypeReducer, buildingReducer, projectReducer, generalsettingReducer };
};

export default withRouter(
    connect(mapStateToProps, { ...buildingTypeActions, ...buildingActions, ...projectActions })(From)
);
