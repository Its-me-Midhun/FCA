...
class ChartDasboard extends Component {
    state = {
        chartArray: [
            "Building_Energy_Cost",
            "Building_Energy_Use",
            "Site_Energy_Cost",
            "Building_Energy_Use_Intensity",
            "Building_TotalEnergy_Cost",
            "Building_TotalEnergy_Use",
    ...
    renderHeading = type => {
        switch (type) {
            case "Building_Energy_Cost":
                return "Current Entity Building Breakdown Energy Cost Intensity";
            case "Building_Energy_Use":
                return "Current Entity Building Breakdown Energy Use Intensity";
            case "Site_Energy_Cost":
                return "Current Entity Site Breakdown for Site Energy Cost Intensity";
            case "Building_Energy_Use_Intensity":
                return "Current Entity Site Breakdown for Site Energy Use Intensity ";
            case "Building_TotalEnergy_Cost":
                return "Current Entity Building Breakdown Total Energy Cost per Year";
            case "Building_TotalEnergy_Use":
                return "Current Entity Building Breakdown Total Energy Usage per Year";
            case "Energy_Cost_Analysis":
                return "Current Entity Energy Unit Cost Analysis per Year";
        }
    };
