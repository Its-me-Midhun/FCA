...
export const getAllClients = params => fcaGateWay.get(serviceEndpoints.energyManagementEndponts.getClients, { params });
export const getClientsId = id => fcaGateWay.get(`${serviceEndpoints.energyManagementEndponts.getClients}/${id}`);

// Regions
export const getAllRegions = params => {
    return fcaGateWay.get(serviceEndpoints.regionEndPoints.getAllRegions, { params });
};
export const getRegionById = id => fcaGateWay.get(`${serviceEndpoints.regionEndPoints.getRegionById}/${id}`);
