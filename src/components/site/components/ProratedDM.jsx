...
class ProratedDM extends Component {
    state = {
        activeTab: false,
    ...
    render() {
        let filteredData = this.props.proDifferedMaintenance.data.map(i => uniqBy(i.data, "year"));
        return (
            <div>
                <div class="table-topper">
                    <div class="col-md-12 otr-topr">
                        <h3>
                            {`${
                                this.props.proDifferedMaintenance &&
                                this.props.proDifferedMaintenance.data &&
                                this.props.proDifferedMaintenance.data.length &&
                                this.props.proDifferedMaintenance.data[0].data &&
                        ...
                        <h4>
                            Yearly Deferred Maintennace Spending Summary –
                            {this.props.activeTabString}
                        </h4>
                    </div>
                </div>
                    ...
                    <table class="table table-common">
                        <thead>
                            <tr>
                                ...
                                {this.props.proDifferedMaintenance &&
                                    this.props.proDifferedMaintenance.data &&
                                    this.props.proDifferedMaintenance.data.length &&
                                    this.props.proDifferedMaintenance.data[0].data.map(i => {
                                        return (
                                            <>
                                                <th class="build-year">
                        ...
                        <tbody>
                            {this.props.proDifferedMaintenance &&
                                this.props.proDifferedMaintenance.data &&
                                this.props.proDifferedMaintenance.data.length &&
                                this.props.proDifferedMaintenance.data.map((item, i) => {
                                    return (
                                        <>
                                            <tr>
