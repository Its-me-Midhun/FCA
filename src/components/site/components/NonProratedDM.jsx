...
class NonProratedDM extends Component {
    state = {
        activeTab: false,
    ...
    render() {
        let filteredData = this.props.differedMaintenance.data.map(i => uniqBy(i.data, "year"));
        return (
            <div>
                <div class="table-topper">
                    <div class="col-md-12 otr-topr">
                        <h3>
                            {`${
                                this.props.differedMaintenance &&
                                this.props.differedMaintenance.data[0].data &&
                    ...
                    <table class="table table-common">
                        <thead>
                            <tr>
                                ...
                                {this.props.differedMaintenance &&
                                    this.props.differedMaintenance.data[0] &&
                                    filteredData[0].map(i => {
                                        return (
                                            <>
                                                <th class="build-year">
                        ...
                        <tbody>
                            {this.props.differedMaintenance &&
                                this.props.differedMaintenance.data.map((item, i) => {
                                    return (
                                        <>
                                            <tr>
