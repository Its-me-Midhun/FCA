...
class MainAnnualEfciCalculation extends Component {
    state = {
        loading: false,
        selectedCell: null,
                                                            ...
                                                            <>
                                                                <NumberFormat
                                                                    ...
                                                                    onValueChange={async values => {
                                                                        ...
                                                                        return this.props.isApi ? "" : await this.props.handleMainEntityAnnualEfci(amount.id, value, amount.index);
                                                                    ...
                                                                    onKeyPress={async event => {
                                                                        if (event.key === "Enter") {
                                                                            ...
                                                                            await this.props.updateMainEntityAnnualEFCI(amount.id, amount.value);
                                                                            await this.setState({
                                                                                selectedCell: null,
                                                                                initialCellValue: amount.value
                                                                            });
                                                                    ...
                                                                    onBlur={async () => {
                                                                        await this.props.handleMainEntityAnnualEfci(amount.id, this.state.initialCellValue, amount.index);
                                                                        await this.setState({
                                                                            selectedCell: null,
                                                                            initialCellValue: null
                                                                        });
...
export default withRouter(MainAnnualEfciCalculation);
