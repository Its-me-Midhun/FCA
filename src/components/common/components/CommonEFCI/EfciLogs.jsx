...
class EFCILogs extends Component {
    ...
    render() {
        const { logs, numberOfYears, totalFunding, isPercentage, isValue, sortFundingEfci } = this.props;
        const { sortOrder, paginationParams } = this.state;
        let keyValue = isPercentage ? "percentage" : isValue ? "value" : "amount";
        return (
            <>
                <React.Fragment>
                    <div
                        ...
                        <LoadingOverlay active={this.props.hasLoading} spinner={<Loader />} fadeSpeed={10}>
                            <div class="modal-dialog log-width" role="document">
                                <div class="modal-content">
                                    <HelperIcon isHistory={true} entity={"general"} additoinalClass={"is-modal-view"} />
                                                                    ...
                                                                    <>
                                                                        <tr>
                                                                            <td>
                                                                                {totalFunding ? (
                                                                                    <>
                                                                                        <b> {log.user}</b> changed {<b>{keyValue}</b>} from
                                                                                        <b>
                                                                                            {
                                                                                                <NumberFormat
                                                                                                    prefix={"$ "}
                                                                                                ...
                                                                                                <NumberFormat
                                                                                                    ...
                                                                                                    value={
                                                                                                        isPercentage
                                                                                                            ? log &&
                                                                                                              log.changeset &&
                                                                                                              log.changeset.percentage &&
                                                                                                              log.changeset.percentage[0]
                                                                                                            : (log &&
                                                                                                                  log.changeset &&
                                                                                                                  log.changeset.value &&
                                                                                                                  log.changeset.value[0]) ||
                                                                                                              (log &&
                                                                                                                  log.changeset &&
                                                                                                                  log.changeset.amount &&
                                                                                                                  log.changeset.amount[0]) ||
                                                                                                              0
                                                                                                    }
                                                                                                />
                                                                                            }
