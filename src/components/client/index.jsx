...
import { clientTableData } from "../../config/tableData";
...
class index extends Component {
    state = {
        ...
        tableData: {
            ...
            config: this.props.clientReducer.entityParams.tableConfig || _.cloneDeep(clientTableData.config)
        },
        alertMessage: "",
    ...
    showEditPage = buildingTypeId => {
        ...
        addToBreadCrumpData({ key: "edit", name: "Edit Client", path: `/client/edit/${buildingTypeId}` });
        history.push(`/client/edit/${buildingTypeId}`);
    };
    ...
    handleAddBuildingType = async client => {
        ...
        if (this.props.clientReducer.addClientResponse && this.props.clientReducer.addClientResponse.error) {
            ...
            let client_id = this.props.clientReducer.addClientResponse?.id || "";
            await this.props.copyGlobalChartTemplates({ client_id });
            await this.refreshBuildingTypeList();
            this.setState({
                isLoading: false
            });
            ...
            infoTabsData: [
                {
                    key: "basicdetails",
                    name: "Client",
                    path: `/client/clientinfo/${buildingTypeId}/basicdetails`
                },
                    ...
                    ? [
                          {
                              ...
                              path: `/client/clientinfo/${buildingTypeId}/chartProperties`
                          }
                      ]
                    : []),
                ,
                ...(checkPermission("forms", "client_chart_templates", "view")
                    ? [
                          {
                              key: "chart_templates",
                              name: "Export Templates",
                              path: `/client/clientinfo/${buildingTypeId}/chart_templates`
                          }
                      ]
                    : []),
                ,
                {
                    ...
                    path: `/client/clientinfo/${buildingTypeId}/passwordsettings`
                },
                {
                    key: "documents",
                    name: "Documents",
                    path: `/client/clientinfo/${buildingTypeId}/documents`
                }
            ]
        });
        let tabKeyList = ["basicdetails", "documents", "chartProperties", "chart_templates", "passwordsettings"];
        history.push(
            `/client/clientinfo/${buildingTypeId}/${
