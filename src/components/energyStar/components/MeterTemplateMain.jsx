...
import energyStarActions from "../actions";
                ...
                <div className={`dtl-sec col-md-12`}>
                    <div className="table-top-menu allign-right">
                        <div className="rgt">
                            ...
                            />
                            {showAddButton && (
                                <button className="add-btn mr-2" onClick={() => showAddForm()}>
                                    <i className="fas fa-plus" /> Add Energy Star Rating
                                </button>
                            )}
                        </div>
                    </div>
                    <Table
                        ...
                        summaryRowDataEnergy={summaryRowData}
                    />
...
const mapStateToProps = state => {
    const { energyStarReducer } = state;
    return { energyStarReducer };
};

export default withRouter(connect(mapStateToProps, { ...energyStarActions })(SiteMain));
