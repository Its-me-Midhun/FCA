...
const updateNarrativeTemplateEntityParams = entityParams => {
    return async dispatch => {
        try {
            if (entityParams) {
                dispatch({
                    type: actionTypes.UPDATE_NARRATIVE_TEMPLATE_ENTITY_PARAMS_SUCCESS_ENERGYSTAR,
                    response: entityParams
                });
            }
        } catch (e) {
            dispatch({
                type: actionTypes.UPDATE_NARRATIVE_TEMPLATE_ENTITY_PARAMS_FAILURE_ENERGYSTAR,
                error: entityParams
            });
        }
    };
