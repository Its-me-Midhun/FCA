...
class MeterTemplateInfo extends Component {
    ...
    refreshinfoDetails = async () => {
        let meterTemplateData = await this.props.getDataById(this.props.match.params.id);
        if (meterTemplateData && meterTemplateData.success) {
            this.setState({
                basicDetails: {
                    code: meterTemplateData?.code,
                    client: meterTemplateData?.client,
                    ...
                    account_type: meterTemplateData?.account?.account_type,
                    account_description: meterTemplateData?.account?.description,
                    meter_type: meterTemplateData?.meter_type,
                    meter: meterTemplateData?.meter,
                    description: meterTemplateData?.description,
