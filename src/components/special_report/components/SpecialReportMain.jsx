...
class SiteMain extends Component {
    render() {
        const {
            ...
            wildCardFilter,
            handleHideColumn,
            getListForCommonFilterSpecialReport,
            updateCommonFilter,
            commonFilter,
            resetAllFilters,
            resetAll,
            ...
            <React.Fragment>
                <div className={`${section !== "regioninfo" ? "dtl-sec" : ""} col-md-12 floor-detail master-templates`}>
                    ...
                    <Table
                        ...
                        handleDeleteItem={handleDeleteSpecialReport}
                        showWildCardFilter={showWildCardFilter}
                        ...
                        getListForCommonFilter={getListForCommonFilterSpecialReport}
