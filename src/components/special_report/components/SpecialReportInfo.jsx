...
class SpecialReportInfo extends Component {
    state = {
        isloading: true,
        basicDetails: {
            name: "",
        ...
        if (narrativeTemplateData && narrativeTemplateData.success) {
            this.setState({
                basicDetails: {
                    ...
                    display_name: narrativeTemplateData.display_name,
    ...
    restoreLogOnConfirm = async () => {
        ...
        await this.props.HandleRestoreSpecialReportLog(selectedLog);
        this.setState({
            showConfirmModalLog: false,
            selectedLog: null,
            isHistory: false
...
export default withRouter(SpecialReportInfo);
