...
class From extends Component {
        ...
        if (selectedSpecialReport) {
            ...
            const {
                specialReportReducer: {
                    getSpecialReportByIdResponse: { success, name, display_name, note, description }
                }
            } = this.props;
    ...
    validate = () => {
        ...
        if (!specialReport.display_name || !specialReport.display_name.trim().length) {
                ...
                <div className="dtl-sec col-md-12">
                    <div className="tab-dtl region-mng">
                        <ul>
                            ...
                            <li className="active pl-4">{selectedSpecialReport ? "Edit Special Report" : "Add Special Report"}</li>
                        </ul>
                                            ...
                                            <div className="col-md-4 basic-box">
                                                <div className="codeOtr">
                                                    ...
                                                    <input
                                                        ...
                                                        value={specialReport.display_name}
                                                        onChange={e =>
                                                            this.setState({
                                                                specialReport: {
                                                                    ...specialReport,
