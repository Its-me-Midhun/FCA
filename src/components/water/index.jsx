...
class index extends Component {
    state = {
        ...
        errorMessage: "",
        projectList: [],
        paginationParams: this.props.waterReducer.entityParams.paginationParams,
        showViewModal: false,
        ...
        tableLoading: false,
        projectData: {},
        selectedRowId: this.props.waterReducer.entityParams.selectedRowId,
        params: this.props.waterReducer.entityParams.params,
        selectedBuilding: this.props.match.params.id || null,
        selectedMeterTemplate: this.props.match.params.id || this.props.waterReducer.entityParams.selectedEntity,
        tableData: {
            keys: electricTableData.keys,
            config: this.props.waterReducer.entityParams.tableConfig || electricTableData.config
        },
        infoTabsData: [],
        alertMessage: "",
        wildCardFilterParams: this.props.waterReducer.entityParams.wildCardFilterParams,
        filterParams: this.props.waterReducer.entityParams.filterParams,
        historyPaginationParams: this.props.waterReducer.entityParams.historyPaginationParams,
        historyParams: this.props.waterReducer.entityParams.historyParams,
        logData: {
            count: "",
            data: []
        },
    ...
    refreshMeterList = async () => {
        ...
        meterList = this.props.waterReducer.getAllMeterReadingsResponse ? this.props.waterReducer?.getAllMeterReadingsResponse?.readings : [];
        totalCount = this.props.waterReducer.getAllMeterReadingsResponse ? this.props.waterReducer.getAllMeterReadingsResponse?.count : 0;
        totals = this.props.waterReducer.getAllMeterReadingsResponse ? this.props.waterReducer.getAllMeterReadingsResponse?.totals : {};
        ...
        if (meterList && !meterList.length && paginationParams.currentPage) {
            ...
            await this.props.getAllReadings({ ...params, ...subParams, meter_type: tab });
            meterList = this.props.waterReducer.getAllMeterReadingsResponse ? this.props.waterReducer?.getAllMeterReadingsResponse : [];
            totalCount = this.props.waterReducer.getAllMeterReadingsResponse ? this.props.waterReducer.getAllMeterReadingsResponse?.count : 0;
        }
        ...
        if (
            meterList &&
            !meterList.length &&
            this.props.waterReducer.getAllMeterReadingsResponse &&
            this.props.waterReducer.getAllMeterReadingsResponse.error
        ) {
            await this.setState({ alertMessage: this.props.waterReducer.getAllMeterReadingsResponse.error });
            this.showAlert();
        }
        ...
        this.setState({
            tableData: {
                ...tableData,
                data: meterList,
                config: this.props.waterReducer.entityParams.tableConfig || tableData.config
            },
            meterList,
    ...
    getListForCommonFilter = async params => {
        ...
        return (this.props.waterReducer.getListForCommonFilterResponse && this.props.waterReducer.getListForCommonFilterResponse.list) || [];
    };
    ...
    handleAddMeterTemplate = async narrativeTemplate => {
        ...
        if (this.props.waterReducer.addMeterTemplateResponse && this.props.waterReducer.addMeterTemplateResponse.error) {
            await this.setState({
                alertMessage: this.props.waterReducer.addMeterTemplateResponse.error
            });
            this.showAlert();
        } else {
            await this.setState({
                alertMessage: this.props.waterReducer.addMeterTemplateResponse && this.props.waterReducer.addMeterTemplateResponse.message
            });
            this.showAlert();
            await this.refreshMeterList();
            history.push(path);
    ...
    handleUpdateMeterTemplate = async (meterTemplate_id, meterTemplate) => {
        ...
        if (this.props.waterReducer.updateMeterTemplateResponse && this.props.waterReducer.updateMeterTemplateResponse.error) {
            await this.setState({ alertMessage: this.props.waterReducer.updateMeterTemplateResponse.error });
            this.showAlert();
        } else {
            this.setState({
                alertMessage:
                    (this.props.waterReducer.updateMeterTemplateResponse && this.props.waterReducer.updateMeterTemplateResponse.message) ||
    ...
    deleteMeterTemplateOnConfirm = async () => {
        ...
        if (this.props.waterReducer.deleteMeterTemplateResponse && this.props.waterReducer.deleteMeterTemplateResponse.error) {
            await this.setState({ alertMessage: this.props.waterReducer.deleteMeterTemplateResponse.error });
            this.setState({
            ...
            await this.setState({ alertMessage: this.props.waterReducer.deleteMeterTemplateResponse.message || "Deleted successfully" });
            await this.refreshMeterList();
            this.setState({
                showConfirmModal: false,
                selectedBuilding: null
    ...
    getDataById = async meterTemplateId => {
        ...
        return this.props.waterReducer.getMeterTemplateByIdResponse;
    };
    ...
    exportTableXl = async () => {
        ...
        if (this.props.waterReducer.narrativeTemplateExportResponse && this.props.waterReducer.narrativeTemplateExportResponse.error) {
            await this.setState({ alertMessage: this.props.waterReducer.narrativeTemplateExportResponse.error });
            this.showAlert();
        }
    };
    ...
    getLogData = async () => {
        ...
        if (this.props.waterReducer.getAllNarrativeTemplateLogsResponse && this.props.waterReducer.getAllNarrativeTemplateLogsResponse.error) {
            await this.setState({ alertMessage: this.props.waterReducer.getAllNarrativeTemplateLogsResponse.error });
            this.showAlert();
        } else {
            await this.setState({
                logData: {
    ...
    deleteLogOnConfirm = async () => {
        ...
        if (this.props.waterReducer.deleteNarrativeTemplateLogResponse && this.props.waterReducer.deleteNarrativeTemplateLogResponse.error) {
            await this.setState({ alertMessage: this.props.waterReducer.deleteNarrativeTemplateLogResponse.error });
            this.showAlert();
        }
        await this.getLogData(this.props.match.params.id);
        this.setState({
    ...
    HandleRestoreRegionLog = async id => {
        ...
        if (this.props.waterReducer.restoreNarrativeTemplateLogResponse && this.props.waterReducer.restoreNarrativeTemplateLogResponse.error) {
            await this.setState({ alertMessage: this.props.waterReducer.restoreNarrativeTemplateLogResponse.error });
            this.showAlert();
        }
    };
...
const mapStateToProps = state => {
    const { projectReducer, commonReducer, waterReducer } = state;
    return { projectReducer, commonReducer, waterReducer };
};
