        ...
        if (floorData && floorData.success) {
            this.setState({
                basicDetails: {
                    code: floorData.code,
                    name: floorData.name,
                    consultancy: floorData.consultancy,
                    client_users: floorData.client_users,
                    building: floorData.building.name,
                    client: floorData.client,
                    region: floorData.region,
                    site: floorData.site,
                    users: floorData.users,
                    comments: floorData.comments,
...
export default withRouter(FloorInfo);
