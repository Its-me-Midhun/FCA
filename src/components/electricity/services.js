...
export const getAllMeterReadings = params => fcaGateWay.get(serviceEndpoints.energyManagementEndponts.getReadingDetails, { params });
...
export const addMeterTemplate = payload => fcaGateWay.post(`${serviceEndpoints.energyManagementEndponts?.postReadingDetails}`, payload);

export const getMeterTemplateById = meterTemplate_id =>
    fcaGateWay.get(`${serviceEndpoints.energyManagementEndponts.getReadingDetails}/${meterTemplate_id}`);

export const updateMeterTemplate = (meterTemplate_id, payload) =>
    fcaGateWay.patch(`${serviceEndpoints.energyManagementEndponts.patchReadingDetails}/${meterTemplate_id}`, payload);
export const deleteMeterTemplate = meterTemplate_id =>
    fcaGateWay.delete(`${serviceEndpoints.energyManagementEndponts.deleteReadingDetails}/${meterTemplate_id}`);
export const getListForCommonFilter = params =>
    fcaGateWay.get(`${serviceEndpoints.narrativeTemplateEndPoints.getListForCommonFilter}/energy_management/meter_readings/get_list`, {
        params
    });
...
export const getAllNarrativeTemplateLogs = (id, params) => {
    ...
    return fcaGateWay.get(`${serviceEndpoints.energyManagementEndponts.getAllNarrativeTemplateLogs}/${id}/logs`, { params });
};
