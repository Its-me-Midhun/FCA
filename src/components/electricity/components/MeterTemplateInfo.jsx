        ...
        if (meterTemplateData && meterTemplateData.success) {
            this.setState({
                basicDetails: {
                    ...
                    kwh_usage: meterTemplateData?.kwh_usage,
                    mmbtu_usage: meterTemplateData?.mmbtu_usage,
                    kw_usage: meterTemplateData?.kw_usage,
                    kwh_cost: `$ ${meterTemplateData?.kwh_cost}`,
                    kw_cost: `$ ${meterTemplateData?.kw_cost}`,
                    total_electric_cost: `$ ${meterTemplateData?.total_electric_cost}`,
