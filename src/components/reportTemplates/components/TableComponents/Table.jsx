                        ...
                        <thead>
                            <tr>
                                ...
                                {hasActionColumn && !isBuildingLocked && !isAssignProject ? (
                                    <th className={`action ${isReportTemplate ? "w-action" : ""}`}>Action</th>
                                ) : null}
                            </tr>
                        </thead>
                                ...
                                <>
                                    {tableData.data.map((dataItem, i) => (
                                        <Row
                                            ...
                                            hasExport={hasExport}
                                            hasTableImport={hasTableImport}
                                            handleDownloadItemImport={handleDownloadItemImport}
                                            showEditExportPage={showEditExportPage}
                                        />
                                    ))}
                                    <SummaryRow
                                        keys={tableData.keys}
