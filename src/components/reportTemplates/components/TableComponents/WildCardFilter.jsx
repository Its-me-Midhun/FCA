    ...
    setFilterKeysForDate = async (filterKey, searchKey, keyItem) => {
        ...
        if (this.state.selectedDateFilterKey[keyItem] !== filterKey) {
            ...
            if (filterKey !== "in_between") {
                ...
                if (keyItem === "uploaded_at" || keyItem === "created_at") {
                ...
                } else if (keyItem === "read_at") {
                    prevFilterKeys.min_read_at = this.state.filterDate[keyItem].from;
                    prevFilterKeys.max_read_at = this.state.filterDate[keyItem].to;
                } else if (keyItem === "seen_at") {
                    prevFilterKeys.min_seen_at = this.state.filterDate[keyItem].from;
                    prevFilterKeys.max_seen_at = this.state.filterDate[keyItem].to;
                }
            } else {
                tempWcFilter[searchKey].filters = [tempFilterKey];
                tempWcFilter[searchKey].key = {
