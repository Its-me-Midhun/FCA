...
class SiteMain extends Component {
    render() {
        const {
            ...
            wildCardFilter,
            handleHideColumn,
            getListForCommonFilterChildParagraph,
            updateCommonFilter,
            ...
            <React.Fragment>
                <div className={`${section !== "regioninfo" ? "dtl-sec" : ""} col-md-12 floor-detail master-templates`}>
                        ...
                        <div className="rgt">
                            ...
                            {showAddButton && (
                                <button className="add-btn" onClick={() => showAddForm()}>
                                    <i className="fas fa-plus" /> Add Child Paragraph
                                </button>
                            )}
                        </div>
                    </div>
                    <Table
                        ...
                        handleDeleteItem={handleDeleteChildParagraph}
                        showWildCardFilter={showWildCardFilter}
                        ...
                        getListForCommonFilter={getListForCommonFilterChildParagraph}
