...
class ChildParagraphInfo extends Component {
    state = {
        isloading: true,
        basicDetails: {
            name: "",
        ...
        if (narrativeTemplateData && narrativeTemplateData.success) {
            this.setState({
                basicDetails: {
                    ...
                    report_paragraph: narrativeTemplateData.report_paragraph?.name,
    ...
    restoreLogOnConfirm = async () => {
        ...
        await this.props.HandleRestoreChildParagraphLog(selectedLog);
        this.setState({
            showConfirmModalLog: false,
            selectedLog: null,
            isHistory: false
...
export default withRouter(ChildParagraphInfo);
