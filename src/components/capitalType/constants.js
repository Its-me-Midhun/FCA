export const GET_CAPITAL_TYPE_SETTINGS_DATA_REQUEST = "GET_CAPITAL_TYPE_SETTINGS_DATA_REQUEST";
export const GET_CAPITAL_TYPE_SETTINGS_DATA_SUCCESS = "GET_CAPITAL_TYPE_SETTINGS_DATA_SUCCESS";
export const GET_CAPITAL_TYPE_SETTINGS_DATA_FAILURE = "GET_CAPITAL_TYPE_SETTINGS_DATA_FAILURE";

export const GET_CAPITAL_TYPE_BY_ID_REQUEST = "GET_CAPITAL_TYPE_BY_ID_REQUEST";
export const GET_CAPITAL_TYPE_BY_ID_SUCCESS = "GET_CAPITAL_TYPE_BY_ID_SUCCESS";
export const GET_CAPITAL_TYPE_BY_ID_FAILURE = "GET_CAPITAL_TYPE_BY_ID_FAILURE";

export const UPDATE_CAPITAL_TYPE_REQUEST = "UPDATE_CAPITAL_TYPE_REQUEST";
export const UPDATE_CAPITAL_TYPE_SUCCESS = "UPDATE_CAPITAL_TYPE_SUCCESS";
export const UPDATE_CAPITAL_TYPE_FAILURE = "UPDATE_CAPITAL_TYPE_FAILURE";
...
export const UPDATE_CAPITAL_TYPE_ENTITY_PARAMS_SUCCESS = "UPDATE_CAPITAL_TYPE_ENTITY_PARAMS_SUCCESS";
export const UPDATE_CAPITAL_TYPE_ENTITY_PARAMS_FAILURE = "UPDATE_CAPITAL_TYPE_ENTITY_PARAMS_FAILURE";
