...
import FormModalCapitalType from "../../../capitalType/components/Form";
...
class SettingsInfo extends Component {
    state = {
        ...
        tabledata:
            this.props.activetab === "subsystem"
                ...
                ? prioritysettingsTableData
                : this.props.activetab === "capitalType"
                ? capitalTypeTableData
                : this.props.activetab === "category"
                ? categorysettingsTableData
                : tradesettingsTableData,
        basicDetails: {
            name: "",
        ...
        showFormModalCapitalType: false
    };
        ...
        if (floorData && floorData.success) {
            this.setState({
                basicDetails: {
                    ...
                    benchmark: floorData.benchmark,
                    color_code: floorData.color_code,
                    service_life: floorData.service_life,
                    assigned_bands: floorData.assigned_bands
                },
                isloading: false
            });
        }
    ...
    showEditModal = async tradeId => {
        ...
        } else if (activetab === "capitalType") {
            this.toggleShowFormModalCapitalType();
        } else {
    ...
    toggleShowFormModalCapitalType = () => {
        this.setState({
            showFormModalCapitalType: !this.state.showFormModalCapitalType
        });
    };
    ...
    renderFormModalCapitalType = () => {
        const { showFormModalCapitalType } = this.state;
        if (!showFormModalCapitalType) return null;

        return (
            <Portal
                body={
                    <FormModalCapitalType
                        onCancel={this.toggleShowFormModalCapitalType}
                        selectedItem={this.state.selectedTrade}
                        addNewData={this.addNewTrade}
                        handleUpdateCapitalType={this.updateTrade}
                        selectedTrade={this.state.selectedTrade}
                        getCapitalTypeByOne={this.getTradeById}
                        addNewCategoryData={this.addNewCategory}
                        type={this.state.settingType}
                    />
                }
    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                {this.renderFormModalCapitalType()}
            </React.Fragment>
        );
    }
}
