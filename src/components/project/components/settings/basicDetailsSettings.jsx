...
class BasicDetails extends Component {
    ...
    updateBenchmark = () => {
        ...
        this.props.updateBenchmark({ benchmark: selectedBenchmark ? "yes" : "no" }, this.props.match.params.subId);
    };
    render() {
        const {
            basicDetails,
                ...
                <div className="tab-active">
                    <div className="otr-edit-delte col-md-12 text-right">
                        {keys.includes("benchmark") && (
                            <div class="benchmark-icn-rgt ml-3">
                                              ...
                                              <div key={i} className="col-md-4 basic-box">
                                                  <div className="codeOtr">
                                                      ...
                                                      keyItem === "site" ? (
                                                          ...
                                                          <h3 className="d-flex align-items-center">{basicDetails[keyItem]?.join(", ") || "-"}</h3>
                                                      ) : (
